function param = read_nifti_header(Options)
%
%
% Function which is going return the parameters used in the acquisition of
% the nii files.
%
% param = read_nifti_header()
% param = read_nifti_header(Options); It will return the parameters param
% from the Options in case they are specified
%
% V 1.0 Creation of the document by David Lopez 14.12.2011
%

if nargin < 1
    [fname,pname] = uigetfile('*.*','Select the nii o hdr Philips file ');
...
switch mode
    ...
    otherwise
        error('The file is not .hdr or .nii');
end
